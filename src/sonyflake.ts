...
export class Sonyflake {
     ...
     * Constructor
     */
    public constructor({ epoch = Epoch.UNIX, machineId = DEFAULT_VALUE }: SonyflakeOptions = {}) {
     ...
     */
    public generateCustomId({ timestamp, sequence }: SonyflakeGenerateCustomIdOptions): Snowflake {
        return (
     ...
     */
    public static decomposeTimestamp(snowflake: Snowflake, epoch: number): number {
     ...
     */
    public static decompose(snowflake: Snowflake, { epoch }: SonyflakeDecomposeOptions): DecomposedSonyflake {
        return {
